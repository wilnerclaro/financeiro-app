...
public interface LancamentoFinanceiroApiDoc {
    ...
    @Operation(summary = "Criar lancamento", description = "Cria uma receita ou despesa. Lancamentos pagos movimentam o saldo da conta.")
    @ApiResponse(responseCode = "201", description = "Lancamento criado com sucesso")
    @ApiResponse(responseCode = "400", description = "Requisicao invalida ou regra de negocio violada")
    @ApiResponse(responseCode = "404", description = "Usuario, conta ou categoria nao encontrada")
    ResponseEntity<LancamentoFinanceiroResponse> criar(@Valid @RequestBody CriarLancamentoFinanceiroRequest request);

    @Operation(summary = "Listar lancamentos", description = "Lista lancamentos por usuario com filtros opcionais.")
    ...
    @Operation(summary = "Buscar lancamento", description = "Busca um lancamento financeiro pelo id e usuario.")
    ...
    @Operation(summary = "Atualizar lancamento", description = "Atualiza um lancamento e recalcula o saldo quando necessario.")
    ...
    @Operation(summary = "Pagar lancamento", description = "Marca um lancamento como pago e movimenta o saldo da conta.")
    ...
    @Operation(summary = "Cancelar lancamento", description = "Cancela um lancamento. Se estiver pago, o saldo e estornado.")
