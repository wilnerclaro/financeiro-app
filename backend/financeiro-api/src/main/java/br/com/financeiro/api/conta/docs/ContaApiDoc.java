...
public interface ContaApiDoc {
    ...
    @Operation(summary = "Listar contas", description = "Lista contas por usuario com filtros opcionais.")
    ...
    ResponseEntity<ContaResponse> buscarPorId(
            @PathVariable UUID id,
            @RequestParam UUID usuarioId
    );

    @Operation(summary = "Atualizar conta", description = "Atualiza nome, tipo e status ativo da conta.")
    ...
    @Operation(summary = "Corrigir saldo inicial", description = "Altera o saldo inicial e recalcula o saldo atual com base nos lancamentos pagos.")
    ...
    @ApiResponse(responseCode = "404", description = "Conta nao encontrada")
    ResponseEntity<ContaResponse> ativar(
            @PathVariable UUID id,
            @RequestParam UUID usuarioId
    );
}
